...
class GTN_FeedForward(tf.keras.layers.Layer):
    def __init__(self,
        ...
        self.linear1 = tf.keras.layers.Dense(d_hidden, input_shape=(d_model,), activation=None)
        self.linear2 = tf.keras.layers.Dense(d_model, input_shape=(d_hidden,), activation=None)
